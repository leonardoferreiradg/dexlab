...
Use `ds_component-spec` to document illustration as a design system component with usage rules, `ops_design-review` to evaluate new illustrations against the style guide, or `ui_visual-hierarchy` to ensure illustrations support — and don't compete with — content hierarchy.
