...
Craft interfaces that are polished, distinctive, and free of generic AI aesthetics. Color systems, typography, visual hierarchy, responsive design, illustration style, UI cloning, and wireframing.
...
| Command | Description |
|---------|-------------|
| `/design-screen` | Design a complete screen — from content hierarchy to polished, responsive implementation. |
| `/build-visual-system` | Build the core visual system — color, typography, and hierarchy for a product. |
