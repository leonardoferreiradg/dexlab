...
- Reference `../dexlab/reference/typography.md` for detailed rules
...
- Reference `../dexlab/reference/color-system.md` for token architecture
...
- Reference `../dexlab/reference/spatial-design.md` for layout rules
...
- Reference `../dexlab/reference/motion-design.md` for principles
