...
Apply naming to `ds_component-spec` for component documentation, `ds_designtokens` for token audit, or `ops_design-review` to validate naming consistency across the system.
