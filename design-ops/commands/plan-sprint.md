---
description: Plan a complete design sprint — from challenge framing to Day 5 test logistics.
argument-hint: "[design challenge or problem area]"
---

# /plan-sprint

Turn an ambiguous problem into a structured 5-day sprint with a testable hypothesis and everything booked before Day 1.
...
3. **Map the 5-day schedule** — Use `ops-sprint-plan` to assign activities by day:
   ...
   - Day 4: Prototype (one path, realistic, testable)
   - Day 5: Test (5 users, structured sessions)
...
Complete sprint plan: hypothesis, success criteria, 5-day schedule with owners, participant logistics, and review checkpoints. Ready to run Monday morning.
