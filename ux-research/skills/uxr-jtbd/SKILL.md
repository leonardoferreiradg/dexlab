...
Use `product-opportunity` to frame JTBD outcomes as design opportunities, `product-prd` to translate to requirements, or `uxr-synthetic-persona` to layer behavioral profiles onto the job map.
