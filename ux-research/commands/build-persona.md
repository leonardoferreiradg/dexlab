...
1. **Build the behavioral persona** — Use `uxr-synthetic-persona` to construct the persona from research data: behavior patterns, goals, frustrations, context of use. Every attribute traced to observed behavior. Demographics are context — not the persona.
...
Use `/uxr-journey-map` to map this persona's end-to-end experience, or `/uxr-synthetic-persona` to translate persona insights into design opportunities.
